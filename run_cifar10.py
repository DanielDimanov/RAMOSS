...
#python run_mnist.py --dataset cifar10 --exp_name cifarExp --pop_size 10 --generations 20 --number_of_runs 1 --seed 42 --type_problem classification --batch_size 32
...
dataset, input_shape,n_classes, TRAIN_WITH_GEN, TRAIN_WITH_LOGITS, batch_size, normalize, multilabel = get_dataset(DATASET,batch_size=BATCH_SIZE)
seed = SEED
seeds_used = []
result = None
...
for run_num in range(NUMBER_OF_RUNS):
  ...
  tf.random.set_seed(seed)
    # 6->10
    # 256 -> 512
  problem = PymooGenomeReduced(max_conv_layers=10, 
                                  max_dense_layers=3,
                                  max_nodes=256,
                                  max_filters=512,
